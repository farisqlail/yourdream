<template>
  <div :class="isDark ? 'dark' : ''">
    <div
      class="navbar dark:bg-gray-900 text-black dark:text-white transition-colors duration-300"
    >
      <div class="flex-1">
        <nuxt-link to="/" class="btn text-xl p-0 btn-title dark:text-white"
          >Your Dream</nuxt-link
        >
      </div>
      <div class="flex-none">
