<template>
  <div>
    <div class="bottom-nav bg-[#f4f4f4] dark:bg-gray-900 dark:text-white">
      <div class="col-1" @click="toHome">
        <div v-if="currentRoute !== '/'">
          <svg
            ...
            class="fill-[#2d2d2e] dark:fill-white"
          >
      ...
      <div class="col-2" @click="toStrategy">
        ...
        <span :class="{ active: isActiveRoute('/strategy') }">Strategiku</span>
      </div>
    </div>
  </div>
</template>
